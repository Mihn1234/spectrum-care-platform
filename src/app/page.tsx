          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Digital transformation suite with crisis management and operational efficiency tools",
                features: ["Automated workflows", "Compliance monitoring", "Resource optimization", "Performance analytics"],
                color: "purple",
                icon: Users
              },
              {
              ...
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 group">
                <CardHeader>
                  <div className={`w-12 h-12 bg-gradient-to-br from-${stakeholder.color}-500 to-${stakeholder.color}-600 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
